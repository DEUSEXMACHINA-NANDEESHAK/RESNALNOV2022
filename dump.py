...
def getCredit(subcode):
    if subcode == "18MAT41":
        return 3
    if subcode == "18CS42" or subcode == "17CS32":
        return 4
    if subcode == "17CS53" or subcode == "18CS33":
        return 3
    if subcode == "17CS54" or subcode == "18CS34":
        return 3
    if subcode == "17CS55" or subcode == "18CS35":
        return 3
    if subcode == "17CS56" or subcode == "18CS36":
        return 3
    
    elif re.search("^..[A-Z][A-Z]?(L|P)[0-9][0-9]$", subcode) is not None:  # Lab
        return 2
